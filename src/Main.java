...
public class Main {
    ...
    public static void testCase() {
        ...
        Command[] cmdlist = {
                new AddCommand(receiver, "^na123me1 name2 testTing"),    // valid
                new AddCommand(receiver, "324name345553 name4 emaIl09"),           // valid
...
//                new UpdateCommand(receiver, "1 name lastname tesTing"),
                new ListCommand(receiver),// starts with dot
...
//                new AddCommand(receiver, "1 name lastname abc.def@domain.com"),      // consecutive dots
